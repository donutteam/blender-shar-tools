...
class Chunk():
	...
	def __init__(self, options: ChunkOptions) -> None:
		...
		self.children = options["children"] if "children" in options else []
	...
	def getDataSize(self) -> int:
		binaryWriter = classes.Pure3DBinaryWriter.Pure3DBinaryWriter()
	...
	def write(self, binaryWriter : classes.Pure3DBinaryWriter.Pure3DBinaryWriter) -> None:
